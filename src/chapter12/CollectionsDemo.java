...
//        System.out.println(fruit); //[banana, orange, apple, lemon]
        ...
        var i = fruit.iterator(); //allow you to go through items
        while (i.hasNext())
        {
            System.out.println(i.next()); //returns an object
        }
        for(String item: fruit) // <String> use it by Set
        {
            System.out.println(item);
        }
        fruit.forEach(x -> System.out.println(x)); // or use fruit.forEach(Syetem.out :: println)
    }
